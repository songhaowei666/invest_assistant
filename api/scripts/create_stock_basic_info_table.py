"""
在 PostgreSQL 中创建或确认存在 stock_basic_info 表，并写入表/列 COMMENT。
...
用法: cd api && python3 scripts/create_stock_basic_info_table.py
"""
import sys
...
from models.stock_basic_info import StockBasicInfo  # noqa: E402
...
def main() -> None:
    ...
    if dialect != "postgresql":
        ...
        sys.exit(1)
    table = StockBasicInfo.__table__
