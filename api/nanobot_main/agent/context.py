...
from nanobot_main.agent.memory import MemoryStore
from nanobot_main.agent.skills import SkillsLoader
from nanobot_main.utils.helpers import build_assistant_message, current_time_str, detect_image_mime, truncate_text
...
class ContextBuilder:
    ...
    def _is_template_content(content: str, template_path: str) -> bool:
        ...
        with suppress(Exception):
            tpl = pkg_files("nanobot_main") / "templates" / template_path
            if tpl.is_file():
