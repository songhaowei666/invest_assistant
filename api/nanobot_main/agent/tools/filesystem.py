...
from nanobot_main.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from nanobot_main.agent.tools.file_state import FileStates, _hash_file, current_file_states
from nanobot_main.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from nanobot_main.utils.document import extract_text
