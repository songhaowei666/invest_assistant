...
from nanobot_main.agent.autocompact import AutoCompact
...
from nanobot_main.agent.memory import Consolidator, Dream
from nanobot_main.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from nanobot_main.agent.skills import BUILTIN_SKILLS_DIR
from nanobot_main.agent.subagent import SubagentManager
from nanobot_main.agent.tools.ask import (
    AskUserTool,
...
from nanobot_main.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from nanobot_main.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from nanobot_main.agent.tools.message import MessageTool
from nanobot_main.agent.tools.notebook import NotebookEditTool
from nanobot_main.agent.tools.registry import ToolRegistry
from nanobot_main.agent.tools.search import GlobTool, GrepTool
from nanobot_main.agent.tools.self import MyTool
from nanobot_main.agent.tools.shell import ExecTool
from nanobot_main.agent.tools.spawn import SpawnTool
from nanobot_main.agent.tools.web import WebFetchTool, WebSearchTool
from nanobot_main.bus.events import InboundMessage, OutboundMessage
from nanobot_main.bus.queue import MessageBus
from nanobot_main.command import CommandContext, CommandRouter, register_builtin_commands
from nanobot_main.config.schema import AgentDefaults
from nanobot_main.providers.base import LLMProvider
from nanobot_main.providers.factory import ProviderSnapshot
from nanobot_main.session.manager import Session, SessionManager
from nanobot_main.utils.document import extract_documents
from nanobot_main.utils.helpers import image_placeholder_text
from nanobot_main.utils.helpers import truncate_text as truncate_text_fn
from nanobot_main.utils.progress_events import (
    build_tool_event_finish_payloads,
    build_tool_event_start_payload,
    invoke_on_progress,
    on_progress_accepts_tool_events,
)
from nanobot_main.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
from nanobot_main.utils.webui_titles import mark_webui_session, maybe_generate_webui_title_after_turn

if TYPE_CHECKING:
    from nanobot_main.config.schema import ChannelsConfig, ExecToolConfig, ToolsConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from nanobot_main.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from nanobot_main.config.schema import ExecToolConfig, ToolsConfig, WebToolsConfig
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nanobot_main.agent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(self, tool_calls: list) -> str:
        ...
        from nanobot_main.utils.tool_hints import format_tool_hints
