...
from nanobot_main import __version__
from nanobot_main.bus.events import OutboundMessage
from nanobot_main.command.router import CommandContext, CommandRouter
from nanobot_main.utils.helpers import build_status_content
from nanobot_main.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "nanobot_main"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from nanobot_main.utils.searchusage import fetch_search_usage
