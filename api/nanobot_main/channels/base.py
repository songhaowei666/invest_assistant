    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from nanobot_main.providers.transcription import OpenAITranscriptionProvider
                ...
                from nanobot_main.providers.transcription import GroqTranscriptionProvider
