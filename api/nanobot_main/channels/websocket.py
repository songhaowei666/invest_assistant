...
from nanobot_main.command.builtin import builtin_command_palette
from nanobot_main.config.paths import get_media_dir
from nanobot_main.config.schema import Base
from nanobot_main.utils.helpers import safe_filename
from nanobot_main.utils.media_decode import (
    FileSizeExceeded,
...
class WebSocketChannel(BaseChannel):
    ...
    def _settings_payload(self, *, requires_restart: bool = False) -> dict[str, Any]:
        ...
        from nanobot_main.providers.registry import PROVIDERS, find_by_name
    ...
    def _handle_settings_update(self, request: WsRequest) -> Response:
        if not self._check_api_token(request):
            return _http_error(401, "Unauthorized")
        from nanobot_main.config.loader import load_config, save_config
