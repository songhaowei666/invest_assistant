...
from nanobot_main import __logo__, __version__
...
from nanobot_main.cli.stream import StreamRenderer, ThinkingSpinner
from nanobot_main.config.paths import get_workspace_path, is_default_workspace
from nanobot_main.config.schema import Config
from nanobot_main.utils.helpers import sync_workspace_templates
from nanobot_main.utils.restart import (
...
def _init_prompt_session() -> None:
    ...
    from nanobot_main.config.paths import get_cli_history_path
...
def onboard(
    ...
    from nanobot_main.config.loader import get_config_path, load_config, save_config, set_config_path
    from nanobot_main.config.schema import Config
    ...
    if wizard:
        from nanobot_main.cli.onboard import run_onboard
...
def _onboard_plugins(config_path: Path) -> None:
    ...
    from nanobot_main.channels.registry import discover_all
...
def _load_runtime_config(config: str | None = None, workspace: str | None = None) -> Config:
    ...
    from nanobot_main.config.loader import load_config, resolve_config_env_vars, set_config_path
...
def _warn_deprecated_config_keys(config_path: Path | None) -> None:
    ...
    from nanobot_main.config.loader import get_config_path
...
def _migrate_cron_store(config: "Config") -> None:
    ...
    from nanobot_main.config.paths import get_cron_dir
...
def serve(
    ...
    from nanobot_main.api.server import create_app
    from nanobot_main.bus.queue import MessageBus
    from nanobot_main.session.manager import SessionManager

    if verbose:
        logger.enable("nanobot_main")
    else:
        logger.disable("nanobot_main")
...
def _run_gateway(
    ...
    *,
    ...
    from nanobot_main.agent.loop import AgentLoop
    from nanobot_main.agent.tools.cron import CronTool
    from nanobot_main.agent.tools.message import MessageTool
    from nanobot_main.bus.queue import MessageBus
    from nanobot_main.channels.manager import ChannelManager
    from nanobot_main.cron.service import CronService
    from nanobot_main.cron.types import CronJob
    from nanobot_main.heartbeat.service import HeartbeatService
    from nanobot_main.providers.factory import build_provider_snapshot, load_provider_snapshot
    from nanobot_main.session.manager import SessionManager
    ...
    from nanobot_main.agent.loop import UNIFIED_SESSION_KEY
    from nanobot_main.bus.events import OutboundMessage
    ...
    async def on_cron_job(job: CronJob) -> str | None:
        ...
        from nanobot_main.utils.evaluator import evaluate_response
    ...
    from nanobot_main.cron.types import CronJob, CronPayload
...
def agent(
    ...
    if message:
        ...
        from nanobot_main.bus.events import InboundMessage
...
def channels_status(
    ...
    """Show channel status."""
    from nanobot_main.channels.registry import discover_all
    from nanobot_main.config.loader import load_config, set_config_path
...
def _get_bridge_dir() -> Path:
    ...
    from nanobot_main.config.paths import get_bridge_install_dir
...
def plugins_list():
    ...
    from nanobot_main.channels.registry import discover_all, discover_channel_names
...
def status():
    """Show nanobot status."""
    from nanobot_main.config.loader import get_config_path, load_config
    ...
    if config_path.exists():
        from nanobot_main.providers.registry import PROVIDERS
...
def _logout_github_copilot() -> None:
    ...
    try:
        from nanobot_main.providers.github_copilot_provider import get_storage
    except ImportError:
...
def _login_github_copilot() -> None:
    try:
        from nanobot_main.providers.github_copilot_provider import login_github_copilot
